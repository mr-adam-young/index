...
CREATE TABLE `Accounts` (
  ...
  `ContactStreet` varchar(45) DEFAULT NULL,
  `ContactCity` varchar(45) DEFAULT NULL,
  `ContactState` varchar(45) DEFAULT NULL,
  `ContactZIP` varchar(45) DEFAULT NULL,
  `ContactBalance` float DEFAULT NULL,
...
-- Dump completed on 2018-09-24 17:53:52
